...
- Installs 11 skills (jeyant v2 + checkpoint + rodin)
- Auto-enables 13 plugins in settings.json
...
Plugins download automatically on first Claude Code launch.
...
### Skills (11, installed in ~/.claude/skills/)

| Skill | Role |
|-------|------|
| **jeyant** | Main pilot — orchestrates the full quality pipeline based on tier |
| **jeyant-cadrage** | Qualifies and formalizes every request into a testable contract |
| **jeyant-brainstorm** | Deep 7-phase exploration (3+ approaches, agentic simulation, failure modes) |
| **jeyant-dev-guard** | Pre-implementation guardrail (pre-flight, conventions, module boundaries) |
| **jeyant-plan** | Decomposes into testable micro-units with dependencies |
| **jeyant-preuves** | Two-phase proof system (contract before code, verification after) |
| **jeyant-revue-adverse** | Adversarial counter-expertise (design scope + code scope) |
| **jeyant-capitalisation** | Captures lessons learned, enriches conventions |
| **jeyant-createur-competence** | Factory for creating new robust, testable skills |
| **checkpoint** | Automates clean commits in Conventional Commits format |
| **rodin** | Socratic sparring partner — anti-echo-chamber |
